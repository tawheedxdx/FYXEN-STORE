    ...
    <section className="py-12">
      <div className="container-custom">
        <motion.div 
          ...
          viewport={{ once: true }}
          className="relative bg-accent rounded-3xl overflow-hidden px-6 py-12 md:p-16 flex flex-col md:flex-row items-center justify-between gap-8"
        >
          {/* Decorative shapes */}
          ...
          <div className="relative z-10 text-center md:text-left">
            <span className="inline-block px-3 py-1 bg-primary-900 text-white text-[10px] font-bold uppercase tracking-widest rounded-full mb-3">
              Limited Time Offer
            </span>
            <h2 className="text-3xl md:text-5xl font-black text-primary-900 mb-4 leading-tight">
              Summer Collection <br className="hidden md:block"/> Now <span className="text-white">Live.</span>
            </h2>
            <p className="text-primary-800 font-medium text-base md:text-lg max-w-md opacity-80">
