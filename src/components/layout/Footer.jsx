...
import { Mail, Phone, Instagram, Facebook, Youtube, Linkedin, ShieldCheck, Truck, RotateCcw, CreditCard } from 'lucide-react';
...
export default function Footer({ settings }) {
  ...
  return (
    <footer className="w-full bg-white dark:bg-[#09090b] relative overflow-hidden">
